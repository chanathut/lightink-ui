...
import { X, CreditCard, Lock, Shield, Check, AlertCircle, Loader2 } from 'lucide-react';
...
export default function PaymentModal({ isOpen, onClose, selectedPlan, onPaymentSuccess }: PaymentModalProps) {
  ...
  const currentPrice = paymentMethod === 'yearly' && selectedPlan.yearlyPrice 
        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-xl font-museo font-bold text-charcoal">Complete Your Purchase</h2>
                <p className="text-sm text-payne">{selectedPlan.name}</p>
              </div>
            </div>
          ...
          <div className="p-6 space-y-6">
                  ...
                  <div className="mb-4">
                    <div className="flex items-center space-x-4 p-3 bg-gray-50 rounded-xl">
                      <label className="flex items-center space-x-2 cursor-pointer">
                        ...
                        />
                        <span className="text-sm">Monthly - ${selectedPlan.price}/month</span>
                      </label>
                      <label className="flex items-center space-x-2 cursor-pointer">
                        <input
                          type="radio"
                          ...
                          onChange={() => setPaymentMethod('yearly')}
                          className="text-tangerine focus:ring-tangerine"
                        />
                        <span className="text-sm">
                          Yearly - ${selectedPlan.yearlyPrice}/year
                          {savings > 0 && (
                ...
                <div className="flex items-center justify-between pt-4">
                  ...
                  <span className="text-2xl font-bold text-charcoal">
                    ...
                    <span className="text-sm font-normal text-payne">
                      /{paymentMethod === 'yearly' ? 'year' : 'month'}
                    </span>
                  </span>
                </div>
              </CardContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* Billing Information */}
              <div className="space-y-4">
                <h3 className="font-semibold text-charcoal">Billing Information</h3>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-green-700">
                      ...
                      SSL encryption and never store your card details.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <Button
                type="submit"
                size="lg"
                className="w-full neo-brutal-button text-lg py-4"
